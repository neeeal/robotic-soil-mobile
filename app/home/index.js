...
export default function Root() {
  return (
    <View className="flex-col h-full">
        <ImageBackground
        source={require('../../assets/images/landing.png')} // Specify the path to your image
        className="flex-row"
    >
        <View className="mx-16 mt-24 mb-20 ">
            <View className="flex">
            ...
            <View className="flex justify-center mt-8">
                <TouchableOpacity style={{backgroundColor:"#878532"}} className="w-full py-3 rounded-lg items-center justify-center">
